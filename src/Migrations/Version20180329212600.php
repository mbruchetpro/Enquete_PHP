 ...
 */
class Version20180329212600 extends AbstractMigration
{
    public function up(Schema $schema)
    {
        ...
        $this->addSql('ALTER TABLE questionnaire ADD auteur VARCHAR(100) NOT NULL');
    }
    ...
    public function down(Schema $schema)
    {
        ...
        $this->addSql('ALTER TABLE questionnaire DROP auteur');
    }
}
